...
<div class="sidebar" data-color="yh">
    	...
    	<div class="sidebar-wrapper">
            ...
            <br/> <br/>
               ...
               <a href="../dashboard/dashboard.php"><img src="../common/core-img/waste.png"  width="195" height="180"></a> 
    ...
    <div class="main-panel" style=" background-image: url(../dashboard/background.jpg); background-size:cover;">
